...
interface SkateboardDocumentData {
  ...
  /**
   * Price (cent field in *Skateboard*
   *
   * - **Field Type**: Number
   * - **Placeholder**: *None*
...
export interface TextAndImageSliceImageOnLiftPrimary {
  ...
  /**
   * Heading field in *TextAndImage → Image on Lift → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_image.imageOnLift.primary.heading
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  heading: prismic.RichTextField;
  ...
  /**
   * Background image field in *TextAndImage → Image on Lift → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_image.imageOnLift.primary.background_image
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  background_image: prismic.ImageField<never>;

  /**
   * Foreground Image field in *TextAndImage → Image on Lift → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_image.imageOnLift.primary.foreground_image
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  foreground_image: prismic.ImageField<never>;
}
